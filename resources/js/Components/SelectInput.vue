...
<template>
    <Listbox v-model="selectedOption">
        <div class="relative">
            <ListboxButton
                :id="id"
                class="relative text-left px-3 py-1.5 border-none pr-8 text-zinc-950 ring-[1px] shadow-sm ring-inset ring-zinc-950/10 hover:ring-zinc-950/20 disabled:opacity-50 disabled:pointer-events-none"
                :class="{
                    'rounded-lg': !trailing,
            ...
            >
                <ListboxOptions
                    class="z-10 overflow-auto absolute p-1 mt-1 max-h-60 font-medium bg-white border border-zinc-950/10 rounded-xl"
                >
                    <ListboxOption
